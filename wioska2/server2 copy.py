...
def chat():
    ...
    instruction_npc1 = f"NPC1: {npc1_background} The topic is {topic}. Please respond naturally to the following input: "
    instruction_npc2 = f"NPC2: {npc2_background} The topic is {topic}. Please respond naturally to the following input: "
